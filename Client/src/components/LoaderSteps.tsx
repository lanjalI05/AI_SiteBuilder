import { CircleIcon, Currency, ScanLineIcon, SquareIcon, TriangleIcon } from "lucide-react"
import { useEffect, useState } from "react";

const steps = [
    {icon: ScanLineIcon, label: 'Analyzing your request...'},
    {icon: SquareIcon, label: 'Greeting layout Structure...'},
    {icon: TriangleIcon, label: 'Assembling components...'},
...
const LoaderSteps = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
        <div className="absolute inset-0 bg-linear-to-br from-blue-500/10 via-purple-500/10 to-fuchsia-50/10 blur-3xl animate-pulse"></div>      
        <div className="relative z-10 w-32 h-32 flex items-center justify-center">
            ...
            <Icon className="w-8 text-white opacity-80 animate-bounce"/>
        </div>
